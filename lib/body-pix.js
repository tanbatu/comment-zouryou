...
!(function (t, e) {
  ...
  var I = (function () {
    ...
    return (
      ...
      (t.prototype.swim = function (t) {
        for (; t > 0 && this.less(O(t), t); )
          this.exchange(t, O(t)), (t = O(t));
      }),
              ...
              for (var f = 0; f < a; ++f) {
                ...
                l < t ||
                  (A(f, l, u, d, e, n) &&
                    s.enqueue({
                      score: l,
                      part: { heatmapY: u, heatmapX: d, id: f },
                    }));
              }
          return s;
        })(a, z, t),
  ...
  function Q(t) {
    ...
    if ("undefined" != typeof HTMLVideoElement && t instanceof HTMLVideoElement)
      return (function (t) {
        return null != t.height && null != t.width
          ? [t.height, t.width]
              ...
              switch (s.label) {
                case 0:
                  return (
                    ...
                    (o = r[0]),
                    (a = r[1]),
                    (u = Z(n.internalResolution, this.baseModel.outputStride, [
                      o,
                      a,
                    ])),
                    (f = tt(t, u)),
                    ...
                    (h = e.tidy(function () {
                      var t,
                        e =
                          O.predictForMultiPersonInstanceSegmentationAndPart(l),
                        r = e.segmentLogits,
                        i = e.longOffsets,
                        s = e.heatmapScores,
                        f = e.offsets,
              ...
              switch (s.label) {
                case 0:
                  return (
                    ...
                    (o = r[0]),
                    (a = r[1]),
                    (f = Z(n.internalResolution, this.baseModel.outputStride, [
                      o,
                      a,
                    ])),
                    (l = tt(t, f)),
                    ...
                    (p = e.tidy(function () {
                      var t =
                          A.predictForMultiPersonInstanceSegmentationAndPart(c),
                        r = t.segmentLogits,
                        i = t.longOffsets,
                        s = t.heatmapScores,
                        l = t.offsets,
  ...
  (t.BodyPix = ht),
        ...
        a(this, void 0, void 0, function () {
          return s(this, function (e) {
            return "ResNet50" ===
              (t = (function (t) {
                if (
                  (null == (t = t || ot).architecture &&
                    (t.architecture = "MobileNetV1"),
                  it.indexOf(t.architecture) < 0)
                )
                  throw new Error(
                ...
                if (
                  ...
                  at[t.architecture].indexOf(t.outputStride) < 0)
                )
                  throw new Error(
                ...
                if (
                  ...
                  st[t.architecture].indexOf(t.multiplier) < 0)
                )
                  throw new Error(
                    "Invalid multiplier " +
                      t.multiplier +
    ...
    (t.blurBodyPart = function (t, e, n, r, o, i, a) {
      ...
      if (Array.isArray(n) && 0 === n.length) u.drawImage(s, 0, 0);
        ...
        u.drawImage(e, 0, 0, c, l),
          yt(u, d, "destination-in"),
          yt(u, s, "destination-over"),
          u.restore();
      }
    }),
    (t.drawBokehEffect = function (t, e, n, r, o, i) {
      ...
      if (Array.isArray(n) && 0 === n.length) s.drawImage(a, 0, 0);
        ...
        var u = (function (t, e) {
          var n = Mt(
            kt(t, { r: 0, g: 0, b: 0, a: 255 }, { r: 0, g: 0, b: 0, a: 0 }),
            Et.mask
          );
        ...
        var d = Q(e),
          f = d[0],
          l = d[1];
        s.drawImage(e, 0, 0, l, f),
          yt(s, u, "destination-in"),
          yt(s, a, "destination-over"),
          s.restore();
      }
    }),
    (t.drawMask = function (t, e, n, r, o, i) {
      ...
      if (
        (d.save(), i && wt(t), d.drawImage(e, 0, 0), (d.globalAlpha = r), n)
      ) {
    ...
    (t.drawPixelatedMask = function (t, e, n, r, o, i, a) {
      ...
      for (var h = 0; h < l.width; h++)
        f.beginPath(),
          ...
          f.moveTo(a * h, 0),
          f.lineTo(a * h, t.height),
          f.stroke();
      for (h = 0; h < l.height; h++)
        f.beginPath(),
          (f.strokeStyle = "#ffffff"),
          f.moveTo(0, a * h),
          f.lineTo(t.width, a * h),
          f.stroke();
      (f.globalAlpha = 1 - r),
    ...
    (t.resizeAndPadTo = function (t, n, r) {
      ...
      return {
        resizedAndPadded: e.tidy(function () {
          ...
          return (
            (n = r
              ? t.reverse(1).resizeBilinear([s, a])
              : t.resizeBilinear([s, a])),
            e.pad3d(n, [
              [f, l],
              [u, d],
              [0, 0],
